...
- The preauth key is generated on the headscale server with `sudo headscale preauthkeys create -u <user> --reusable -e 8760h`, then encrypted into the `nix-secrets` flake.
