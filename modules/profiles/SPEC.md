...
| `laptop` | workstation | `my.power-management`, libinput touchpad (tap, flat accel, disable-while-typing), video-group backlight access, `my.battery-monitor` for every user, at most 2 parallel Nix builds |
