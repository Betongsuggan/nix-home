...

{
  options.my.controller = {
    ...
    mangohudToggle = {
      ...
      package = mkOption {
        ...
        internal = true;
        readOnly = true;
        description = "The generated toggle script.";
      };
    };
  ...
  config = mkIf config.my.controller.enable {
    # MangoHud toggle: watches the controller and flips MangoHud on the chord
    my.controller.mangohudToggle.package = pkgs.writeScriptBin "controller-mangohud-toggle" (
      let
    ...
    home.packages =
      ...
      ++ optional config.my.controller.mangohudToggle.enable config.my.controller.mangohudToggle.package;
      ...
      mkIf (config.my.controller.mangohudToggle.enable && config.my.controller.mangohudToggle.autoStart)
        {
          ...
          Service = {
            Type = "simple";
            ExecStart = "${config.my.controller.mangohudToggle.package}/bin/controller-mangohud-toggle";
            Restart = "always";
            RestartSec = "5s";
          };
