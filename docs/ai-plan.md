...
- [x] **Scorecard** — `docs/ai-scorecard.md` exists with all currently-running models pre-listed and rows for the AI plan's candidate models. Speed/VRAM/quality numbers and verdicts get filled in as models are actually tried.
