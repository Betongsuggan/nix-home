...
- Logitech G13 gaming keypad with declarative key remapping via input-remapper (auto-applies on connect; `g13.nix`). M1 is for WoW wall climbing: a jump-then-forward cycle (Space, W 10 ms later, 50 ms, 30 ms gap) repeated while held (a macro)
