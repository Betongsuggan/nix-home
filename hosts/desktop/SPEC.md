...
- Logitech G13 gaming keypad with declarative key remapping via input-remapper (auto-applies on connect; `g13.nix`). M1 is for WoW wall climbing: W held while M1 is, Space spammed underneath (35 ms down, 25 ms up); a quick tap is one hop (a macro)
